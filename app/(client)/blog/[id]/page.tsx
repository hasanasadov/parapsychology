...
// Sənin layihəndə params Promise olduğu üçün hamısı üçün eyni tip:
type BlogPageProps = {
  params: Promise<{ id: string }>;
};

// SEO metadata – burada da eyni tipi istifadə edirik
...
// Səhifə komponenti – artıq params Promise-dir, async funksiyadır
export default async function BlogDetailPage({ params }: BlogPageProps) {
  ...
  return (
    <main className="min-h-screen p-4 md:p-0 !pb-5 bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-50 py-10">
      <div className="container mx-auto max-w-4xl px-4">
        ...
        {/* Şəkil – next/image ilə */}
        <div className="mt-6">
          <div className="relative w-full max-h-[420px] rounded-xl shadow-md shadow-slate-200 dark:shadow-slate-900 overflow-hidden">
            <Image
              src={`/${blog!.imageUrl}`}
              alt={blog!.title}
              width={1200}
